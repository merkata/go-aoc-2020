...
import (
	...
	"github.com/merkata/go-aoc-2020/day7"
)
...
func TestCustomsCard(t *testing.T) {
	tests := []test{
		...
		{description: "part 2 validation 1",
			input: []string{
				"light red bags contain 1 bright white bag, 2 muted yellow bags.",
				"dark orange bags contain 3 bright white bags, 4 muted yellow bags.",
				"bright white bags contain 1 shiny gold bag.",
		...
		{description: "part 2 validation 2",
			input: []string{
	...
	for _, tc := range tests {
		got := day7.ContainsGoldBag(tc.input, tc.kind)
		if tc.want != got {
